        ...
        <section id="contact" className="bg-forest py-28 text-paper">
          <div className="mx-auto grid max-w-6xl gap-12 px-5 sm:px-6 lg:grid-cols-[1fr_.8fr]">
            ...
            <Reveal delay={.1} className="divide-y divide-paper/15 border-y border-paper/15">
              ...
              <a href="https://www.linkedin.com/in/manshi-kumari-neha-178a261a2?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" className="flex items-center gap-4 py-6 group"><ExternalLink/><div className="flex-1"><span className="block text-[9px] uppercase tracking-widest text-paper/45">LinkedIn</span><strong className="text-sm">Connect on LinkedIn</strong></div><ArrowUpRight className="size-4 transition group-hover:translate-x-1 group-hover:-translate-y-1"/></a>
